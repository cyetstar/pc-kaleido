...
-->
<template>
    <h-form-modal ref="formRef" :label-col="{ span: 4 }" width="600px" v-model:form="form" title="专辑"
                  @submit="onSubmit">
                <h-col :span="24">
                ...
                <h-col :span="24">
                        <h-input label="艺术家" v-model:value="form.artists"
                                 name="artists"/>
                </h-col>
                <h-col :span="24">
                ...
                <h-col :span="24">
                        <h-input label="专辑类型" v-model:value="form.type"
                                 name="type"/>
                </h-col>
                <h-col :span="24">
                        <h-input label="音乐流派" v-model:value="form.genre"
                                 name="genre"/>
                </h-col>
                <h-col :span="24">
                        <h-input label="发行国家" v-model:value="form.releaseCountry"
                                 name="releaseCountry"/>
                </h-col>
                <h-col :span="24">
                        <h-input label="日期" v-model:value="form.date"
                                 name="date"/>
                </h-col>
                <h-col :span="24">
                        <h-input label="唱片公司" v-model:value="form.label"
                                 name="label"/>
                </h-col>
                <h-col :span="24">
                        <h-input label="发行日期" v-model:value="form.releaseDate"
                                 name="releaseDate"/>
                </h-col>
                <h-col :span="24">
                        <h-select label="碟数" dict-type="totalDiscs"
                                  v-model:value="form.totalDiscs" name="totalDiscs"/>
                </h-col>
                <h-col :span="24">
                        <h-select label="音轨数" dict-type="totalTracks"
                                  v-model:value="form.totalTracks" name="totalTracks"/>
                </h-col>
                <h-col :span="24">
                        <h-input label="媒体" v-model:value="form.media"
                                 name="media"/>
                </h-col>
                <h-col :span="24">
                        <h-input label="文件路径" v-model:value="form.path"
                                 name="path"/>
                </h-col>
                <h-col :span="24">
